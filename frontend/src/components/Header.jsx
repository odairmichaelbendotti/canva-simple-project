...
const Header = ({ setShow }) => {
    ...
    return (
        <header className={`py-4 bg-[#202224] z-10 ${pathname !== '/design/create' && 'shadow-md shadow-[#282828]'}`}>
                            ...
                            {pathname === '/design/create' ?
                                (
                                    <div className='flex items-center gap-2'>
                                        <p className='px-6 py-2 bg-[#6F87FA] rounded-sm cursor-pointer text-white font-bold hover:opacity-95'>Save</p>
                                        <p className='px-6 py-2 bg-[#A769F4] rounded-sm cursor-pointer text-white font-bold hover:opacity-95'>Download</p>
                                    </div>
                                ...
                                (
                                    <>
                                        <Link to='/content'>
                                            <button className='py-2 px-6 bg-[#8436D2] text-white rounded-md cursor-pointer hover:opacity-85'>Create a Design
                                            </button>
                                        </Link>
